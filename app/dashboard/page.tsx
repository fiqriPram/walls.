		...
		<div className="mx-auto min-h-screen max-w-5xl px-4 py-8">
			<div className="flex items-center justify-between">
				<div>
					...
					<p className="text-sm text-muted-foreground">Manage your wallpapers</p>
				</div>
			...
			{showForm && (
				<div className="mt-6 rounded-xl border border-border/40 bg-card p-6">
					<h2 className="mb-4 text-lg font-medium">Upload Wallpaper</h2>
			...
			<div className="mt-8">
				<h2 className="mb-4 text-lg font-medium">Wallpapers ({wallpapers.length})</h2>
				{wallpapers.length === 0 ? (
					<div className="rounded-xl border border-border/40 bg-card/50 p-12 text-center">
						<Image className="mx-auto h-12 w-12 text-muted-foreground" />
						<p className="mt-4 text-sm text-muted-foreground">
							No wallpapers yet. Click "Add Wallpaper" to get started.
						</p>
					</div>
				) : (
					<div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
						{wallpapers.map((w) => (
							<div
								key={w.id}
								className="group overflow-hidden rounded-xl border border-border/40 bg-card"
							>
								<div className="relative aspect-video overflow-hidden bg-muted">
									<img src={w.thumbUrl} alt={w.title} className="h-full w-full object-cover" />
